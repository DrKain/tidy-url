...
var validateURL = function (url) {
    try {
        var pass = ['http:', 'https:'];
        var test_1 = new URL(url);
        var prot = test_1.protocol.toLowerCase();
...
var decoders = (_a = {},
    _a[interfaces_1.EEncoding.url] = function (decoded) { return decodeURI(decoded); },
    _a[interfaces_1.EEncoding.urlc] = function (decoded) { return decodeURIComponent(decoded); },
    _a[interfaces_1.EEncoding.base32] = _placeholder,
    _a[interfaces_1.EEncoding.base45] = _placeholder,
    _a[interfaces_1.EEncoding.base64] = function (decoded) { return (0, exports.decodeBase64)(decoded); },
    _a[interfaces_1.EEncoding.binary] = _placeholder,
    _a[interfaces_1.EEncoding.hex] = function (decoded) {
...
var decodeURL = function (str, encoding) {
    if (encoding === void 0) { encoding = interfaces_1.EEncoding.base64; }
    try {
